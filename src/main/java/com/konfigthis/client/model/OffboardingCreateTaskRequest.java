...
public class OffboardingCreateTaskRequest {
 ...
 public enum DefaultAssigneeTypeEnum {
  ...
  public OffboardingCreateTaskRequest() {
  }

  public OffboardingCreateTaskRequest title(String title) {
  ...
  **/
  ...
  public OffboardingCreateTaskRequest description(String description) {
  ...
  **/
  ...
  public OffboardingCreateTaskRequest boardingTaskTemplateCategoryId(Double boardingTaskTemplateCategoryId) {
  ...
  public OffboardingCreateTaskRequest boardingTaskTemplateCategoryId(Integer boardingTaskTemplateCategoryId) {
  ...
  **/
  ...
  public OffboardingCreateTaskRequest dueIn(Double dueIn) {
  ...
  public OffboardingCreateTaskRequest dueIn(Integer dueIn) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "30", required = true, value = "Due date in days before employee last working day")
  ...
  public OffboardingCreateTaskRequest defaultAssigneeType(DefaultAssigneeTypeEnum defaultAssigneeType) {
  ...
  **/
  ...
  public OffboardingCreateTaskRequest assigneeId(Double assigneeId) {
  ...
  public OffboardingCreateTaskRequest assigneeId(Integer assigneeId) {
  ...
  **/
  ...
  public OffboardingCreateTaskRequest requireAttachment(String requireAttachment) {
  ...
  **/
   ...
   * @return the OffboardingCreateTaskRequest instance itself
   */
  public OffboardingCreateTaskRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OffboardingCreateTaskRequest offboardingCreateTaskRequest = (OffboardingCreateTaskRequest) o;
    return Objects.equals(this.title, offboardingCreateTaskRequest.title) &&
        Objects.equals(this.description, offboardingCreateTaskRequest.description) &&
        Objects.equals(this.boardingTaskTemplateCategoryId, offboardingCreateTaskRequest.boardingTaskTemplateCategoryId) &&
        Objects.equals(this.dueIn, offboardingCreateTaskRequest.dueIn) &&
        Objects.equals(this.defaultAssigneeType, offboardingCreateTaskRequest.defaultAssigneeType) &&
        Objects.equals(this.assigneeId, offboardingCreateTaskRequest.assigneeId) &&
        Objects.equals(this.requireAttachment, offboardingCreateTaskRequest.requireAttachment)&&
        Objects.equals(this.additionalProperties, offboardingCreateTaskRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, description, boardingTaskTemplateCategoryId, dueIn, defaultAssigneeType, assigneeId, requireAttachment, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OffboardingCreateTaskRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OffboardingCreateTaskRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OffboardingCreateTaskRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OffboardingCreateTaskRequest is not found in the empty JSON string", OffboardingCreateTaskRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OffboardingCreateTaskRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OffboardingCreateTaskRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OffboardingCreateTaskRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OffboardingCreateTaskRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OffboardingCreateTaskRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<OffboardingCreateTaskRequest>() {
           @Override
           public void write(JsonWriter out, OffboardingCreateTaskRequest value) throws IOException {
           ...
           @Override
           public OffboardingCreateTaskRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OffboardingCreateTaskRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OffboardingCreateTaskRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OffboardingCreateTaskRequest
  * @throws IOException if the JSON string is invalid with respect to OffboardingCreateTaskRequest
  */
  public static OffboardingCreateTaskRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OffboardingCreateTaskRequest.class);
  }

 /**
  * Convert an instance of OffboardingCreateTaskRequest to an JSON string
  *
  * @return JSON string
  */
