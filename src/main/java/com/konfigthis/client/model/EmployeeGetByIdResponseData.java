...
import com.konfigthis.client.model.EmployeeGetByIdResponseDataEmploymentStatusHistoryInner;
import com.konfigthis.client.model.EmployeeGetByIdResponseDataPositionHistoryInner;
import com.konfigthis.client.model.EmployeeGetByIdResponseDataTeamHistoryInner;
...
public class EmployeeGetByIdResponseData {
  ...
  private List<EmployeeGetByIdResponseDataTeamHistoryInner> teamHistory = null;
  ...
  private List<EmployeeGetByIdResponseDataEmploymentStatusHistoryInner> employmentStatusHistory = null;
  ...
  private List<EmployeeGetByIdResponseDataPositionHistoryInner> positionHistory = null;

  public EmployeeGetByIdResponseData() {
  }

  public EmployeeGetByIdResponseData id(Double id) {
  ...
  public EmployeeGetByIdResponseData id(Integer id) {
  ...
  **/
  ...
  public EmployeeGetByIdResponseData email(String email) {
  ...
  **/
  ...
  public EmployeeGetByIdResponseData firstName(String firstName) {
  ...
  **/
  ...
  public EmployeeGetByIdResponseData lastName(String lastName) {
  ...
  **/
  ...
  public EmployeeGetByIdResponseData pictureUrl(String pictureUrl) {
  ...
  **/
  ...
  public EmployeeGetByIdResponseData employmentStartDate(String employmentStartDate) {
  ...
  **/
  ...
  public EmployeeGetByIdResponseData dateOfBirth(String dateOfBirth) {
  ...
  **/
  ...
  public EmployeeGetByIdResponseData team(String team) {
  ...
  **/
  ...
  public EmployeeGetByIdResponseData teamId(Double teamId) {
  ...
  public EmployeeGetByIdResponseData teamId(Integer teamId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "6742", value = "")
  ...
  public EmployeeGetByIdResponseData position(String position) {
  ...
  **/
  ...
  public EmployeeGetByIdResponseData positionId(Double positionId) {
  ...
  public EmployeeGetByIdResponseData positionId(Integer positionId) {
  ...
  **/
  ...
  public EmployeeGetByIdResponseData reportsToEmployeeId(Double reportsToEmployeeId) {
  ...
  public EmployeeGetByIdResponseData reportsToEmployeeId(Integer reportsToEmployeeId) {
  ...
  **/
  ...
  public EmployeeGetByIdResponseData workPhone(String workPhone) {
  ...
  **/
  ...
  public EmployeeGetByIdResponseData homePhone(String homePhone) {
  ...
  **/
  ...
  public EmployeeGetByIdResponseData mobilePhone(String mobilePhone) {
  ...
  **/
  ...
  public EmployeeGetByIdResponseData gender(String gender) {
  ...
  **/
  ...
  public EmployeeGetByIdResponseData streetFirst(String streetFirst) {
  ...
  **/
  ...
  public EmployeeGetByIdResponseData streetSecond(String streetSecond) {
  ...
  **/
  ...
  public EmployeeGetByIdResponseData city(String city) {
  ...
  **/
  ...
  public EmployeeGetByIdResponseData postCode(Double postCode) {
  ...
  public EmployeeGetByIdResponseData postCode(Integer postCode) {
  ...
  **/
  ...
  public EmployeeGetByIdResponseData country(String country) {
  ...
  **/
  ...
  public EmployeeGetByIdResponseData employeeNumber(String employeeNumber) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "A1", value = "")
  ...
  public EmployeeGetByIdResponseData employmentStatus(String employmentStatus) {
  ...
  **/
  ...
  public EmployeeGetByIdResponseData teamHistory(List<EmployeeGetByIdResponseDataTeamHistoryInner> teamHistory) {
  ...
  public EmployeeGetByIdResponseData addTeamHistoryItem(EmployeeGetByIdResponseDataTeamHistoryInner teamHistoryItem) {
  ...
  **/
  ...
  public List<EmployeeGetByIdResponseDataTeamHistoryInner> getTeamHistory() {
    return teamHistory;
  }


  public void setTeamHistory(List<EmployeeGetByIdResponseDataTeamHistoryInner> teamHistory) {
  ...
  public EmployeeGetByIdResponseData employmentStatusHistory(List<EmployeeGetByIdResponseDataEmploymentStatusHistoryInner> employmentStatusHistory) {
  ...
  public EmployeeGetByIdResponseData addEmploymentStatusHistoryItem(EmployeeGetByIdResponseDataEmploymentStatusHistoryInner employmentStatusHistoryItem) {
  ...
  **/
  ...
  public List<EmployeeGetByIdResponseDataEmploymentStatusHistoryInner> getEmploymentStatusHistory() {
    return employmentStatusHistory;
  }


  public void setEmploymentStatusHistory(List<EmployeeGetByIdResponseDataEmploymentStatusHistoryInner> employmentStatusHistory) {
  ...
  public EmployeeGetByIdResponseData positionHistory(List<EmployeeGetByIdResponseDataPositionHistoryInner> positionHistory) {
  ...
  public EmployeeGetByIdResponseData addPositionHistoryItem(EmployeeGetByIdResponseDataPositionHistoryInner positionHistoryItem) {
  ...
  **/
  ...
  public List<EmployeeGetByIdResponseDataPositionHistoryInner> getPositionHistory() {
    return positionHistory;
  }


  public void setPositionHistory(List<EmployeeGetByIdResponseDataPositionHistoryInner> positionHistory) {
   ...
   * @return the EmployeeGetByIdResponseData instance itself
   */
  public EmployeeGetByIdResponseData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EmployeeGetByIdResponseData employeeGetByIdResponseData = (EmployeeGetByIdResponseData) o;
    return Objects.equals(this.id, employeeGetByIdResponseData.id) &&
        Objects.equals(this.email, employeeGetByIdResponseData.email) &&
        Objects.equals(this.firstName, employeeGetByIdResponseData.firstName) &&
        Objects.equals(this.lastName, employeeGetByIdResponseData.lastName) &&
        Objects.equals(this.pictureUrl, employeeGetByIdResponseData.pictureUrl) &&
        Objects.equals(this.employmentStartDate, employeeGetByIdResponseData.employmentStartDate) &&
        Objects.equals(this.dateOfBirth, employeeGetByIdResponseData.dateOfBirth) &&
        Objects.equals(this.team, employeeGetByIdResponseData.team) &&
        Objects.equals(this.teamId, employeeGetByIdResponseData.teamId) &&
        Objects.equals(this.position, employeeGetByIdResponseData.position) &&
        Objects.equals(this.positionId, employeeGetByIdResponseData.positionId) &&
        Objects.equals(this.reportsToEmployeeId, employeeGetByIdResponseData.reportsToEmployeeId) &&
        Objects.equals(this.workPhone, employeeGetByIdResponseData.workPhone) &&
        Objects.equals(this.homePhone, employeeGetByIdResponseData.homePhone) &&
        Objects.equals(this.mobilePhone, employeeGetByIdResponseData.mobilePhone) &&
        Objects.equals(this.gender, employeeGetByIdResponseData.gender) &&
        Objects.equals(this.streetFirst, employeeGetByIdResponseData.streetFirst) &&
        Objects.equals(this.streetSecond, employeeGetByIdResponseData.streetSecond) &&
        Objects.equals(this.city, employeeGetByIdResponseData.city) &&
        Objects.equals(this.postCode, employeeGetByIdResponseData.postCode) &&
        Objects.equals(this.country, employeeGetByIdResponseData.country) &&
        Objects.equals(this.employeeNumber, employeeGetByIdResponseData.employeeNumber) &&
        Objects.equals(this.employmentStatus, employeeGetByIdResponseData.employmentStatus) &&
        Objects.equals(this.teamHistory, employeeGetByIdResponseData.teamHistory) &&
        Objects.equals(this.employmentStatusHistory, employeeGetByIdResponseData.employmentStatusHistory) &&
        Objects.equals(this.positionHistory, employeeGetByIdResponseData.positionHistory)&&
        Objects.equals(this.additionalProperties, employeeGetByIdResponseData.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployeeGetByIdResponseData {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmployeeGetByIdResponseData
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmployeeGetByIdResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmployeeGetByIdResponseData is not found in the empty JSON string", EmployeeGetByIdResponseData.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("team_history") != null && !jsonObj.get("team_history").isJsonNull()) {
        ...
        if (jsonArrayteamHistory != null) {
          ...
          for (int i = 0; i < jsonArrayteamHistory.size(); i++) {
            EmployeeGetByIdResponseDataTeamHistoryInner.validateJsonObject(jsonArrayteamHistory.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("employment_status_history") != null && !jsonObj.get("employment_status_history").isJsonNull()) {
        ...
        if (jsonArrayemploymentStatusHistory != null) {
          ...
          for (int i = 0; i < jsonArrayemploymentStatusHistory.size(); i++) {
            EmployeeGetByIdResponseDataEmploymentStatusHistoryInner.validateJsonObject(jsonArrayemploymentStatusHistory.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("position_history") != null && !jsonObj.get("position_history").isJsonNull()) {
        ...
        if (jsonArraypositionHistory != null) {
          ...
          for (int i = 0; i < jsonArraypositionHistory.size(); i++) {
            EmployeeGetByIdResponseDataPositionHistoryInner.validateJsonObject(jsonArraypositionHistory.get(i).getAsJsonObject());
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmployeeGetByIdResponseData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmployeeGetByIdResponseData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmployeeGetByIdResponseData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmployeeGetByIdResponseData.class));

       return (TypeAdapter<T>) new TypeAdapter<EmployeeGetByIdResponseData>() {
           @Override
           public void write(JsonWriter out, EmployeeGetByIdResponseData value) throws IOException {
           ...
           @Override
           public EmployeeGetByIdResponseData read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmployeeGetByIdResponseData instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmployeeGetByIdResponseData given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmployeeGetByIdResponseData
  * @throws IOException if the JSON string is invalid with respect to EmployeeGetByIdResponseData
  */
  public static EmployeeGetByIdResponseData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmployeeGetByIdResponseData.class);
  }

 /**
  * Convert an instance of EmployeeGetByIdResponseData to an JSON string
  *
  * @return JSON string
  */
